...
public class CreateMorphScreen extends BaseMorphScreen {
    ...
    protected void init() {
...

        {
            ...
            switchButton = new FancySwitchButton(6, this.optionsList.getTop() - 5 - 18,
    ...
    private void setupStoredMorphsWidgets() {
        ...
        int morphListX0 = optionsList.getLeft();
        int morphListX1 = morphListX0 + morphListWidth;

        morphsList = new FancyMorphsList(this.getMinecraft(),
                morphListWidth, 120, morphListY0,
                morphListY1, 22);
        morphsList.setRenderBackground(false);
        morphsList.setRenderTopAndBottom(false);
        morphsList.setLeftPos(morphListX0);
    ...
    private void drawSaveMorphMenuWidgets(FancySimpleButton parentButton) {
        ...
        int yPos0 = optionsList.getTop() + spacingFromMiddle + 20;
