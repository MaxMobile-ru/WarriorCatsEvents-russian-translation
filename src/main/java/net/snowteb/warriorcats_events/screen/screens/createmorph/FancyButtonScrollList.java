    ...
    public class Entry extends AbstractSelectionList.Entry<Entry> {
        ...
        public Entry(String label, Runnable action, String tooltip, String instruction, String key, float scale) {
            ...
            button.setHoverableIn((pMouseX, pMouseY) -> {
                return pMouseX >  FancyButtonScrollList.this.getLeft() && pMouseX < FancyButtonScrollList.this.getLeft() + FancyButtonScrollList.this.getWidth()
                        && pMouseY > FancyButtonScrollList.this.getTop() - 1 && pMouseY < FancyButtonScrollList.this.getBottom();
            });
