...
public class FancyIntSlider extends AbstractSliderButton implements SubRenderable{

    private final int min;
    private final int max;
    private String text;
    private final float scale;
    private final Consumer<FancyIntSlider> onSetValue;


    public FancyIntSlider(int x, int y, int width, int height,
                          int min, int max, int initialValue,
                          Consumer<FancyIntSlider> onSetValue,
                          Component text) {
    ...
    public void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        pGuiGraphics.blitSprite(this.getHandleSprite(),
