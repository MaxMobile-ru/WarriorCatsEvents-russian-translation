...
public class FancyMorphsList extends AbstractSelectionList<FancyMorphsList.Entry> implements SubRenderable {
    ...
    @Override
    protected void renderListItems(GuiGraphics pGuiGraphics, int mouseX, int mouseY, float partialTick) {
        if (this.children().isEmpty()) {
            ...
            pGuiGraphics.pose().translate(i, this.getY() + 10, 0);
        ...
        super.renderListItems(pGuiGraphics, mouseX, mouseY, partialTick);
    }
    ...
    public void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        {
            ...
            pGuiGraphics.blitSprite(FancySimpleButton.FANCY_SPRITES.get(this.active, false),
                    this.getX(), this.getY(), this.getWidth() - 5, this.getHeight());
        ...
        pGuiGraphics.fill(this.getX(), this.getY(),
                this.getX() + width, this.getBottom(),
                0x55000000);
    ...
    protected void enableScissor(GuiGraphics pGuiGraphics) {
        pGuiGraphics.enableScissor(this.getX() + menuX, this.getY(), this.getRight() + menuX, this.getBottom());
    }
    ...
    public class Entry extends AbstractSelectionList.Entry<Entry> {
        ...
        public Entry(String key, ClientStoredMorphs.MorphsFile.MorphData morphData, Runnable onClick) {
            ...
            this.button.setHoverableIn((pMouseX, pMouseY) -> {
                return pMouseX >  FancyMorphsList.this.getX() && pMouseX < FancyMorphsList.this.getX() + FancyMorphsList.this.getWidth()
                        && pMouseY > FancyMorphsList.this.getY() - 1 && pMouseY < FancyMorphsList.this.getBottom();
            });
