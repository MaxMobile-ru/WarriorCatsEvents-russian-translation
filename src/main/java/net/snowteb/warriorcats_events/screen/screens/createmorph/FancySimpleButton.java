...
public class FancySimpleButton extends AbstractButton implements SubRenderable {
    ...
    public static final ResourceLocation FANCY_BUTTON_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(WarriorCatsEvents.MODID, "textures/gui/createmorph/fancy_button.png");
    ...
    protected void renderWidget(GuiGraphics pGuiGraphics, int mouseX, int mouseY, float partialTicks) {
...

        {
            ...
            pGuiGraphics.blitNineSliced(FANCY_BUTTON_TEXTURE,
                    this.getX(), this.getY(),
